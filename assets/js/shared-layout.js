...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-header">
    ...
    <div class="sidebar-brand"><h1>S K ERP</h1><span>Pesticide Management</span></div>
...
<header class="topbar" id="topbar">
  <div class="topbar-left">
    ...
    <div class="topbar-brand">
      <span class="topbar-brand-name">S K ERP</span>
    </div>
  ...
  <div class="topbar-right">
    <button class="btn btn-ghost topbar-install-btn" id="pwa-install-btn" type="button" style="display:none; align-items:center; gap:6px; background: rgba(16, 185, 129, 0.15); color: var(--accent); border: 1px solid rgba(16, 185, 129, 0.35); font-weight: 600; font-size: 13px; padding: 5px 12px; border-radius: 999px;" title="Install S K ERP on your computer">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:15px;height:15px;"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/><polyline points="8 10 12 14 16 10"/><line x1="12" y1="6" x2="12" y2="14"/></svg>
    ...
    <div class="modal-body">
      ...
      <div style="display:grid;gap:12px">
        <div style="padding:14px 16px;border:1px solid var(--border);border-radius:var(--radius);background:var(--bg)">
          ...
          <div style="font-size:14px;font-weight:600;color:var(--text-primary)">S K ERP</div>
        </div>
        <div style="padding:14px 16px;border:1px solid var(--border);border-radius:var(--radius);background:var(--bg)">
